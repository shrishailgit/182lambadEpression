...
public class LambdaEpression {
	...
	public static void main(String[] args) {
		...
		System.out
				.println(vailemail.validate3("^([a-z]{3}[-.])([a-z]+)*@([a-z]{2}[-.])([a-z]{2}[-.])([a-z]+)*$", email));
		...
		System.out.println(
				vaildphonenumber.validate4("^([a-z]{3}[-.])([a-z]+)*@([a-z]{2}[-.])([a-z]{2}[-.])([a-z]+)*$", number));
		...
		System.out.println(validpassword
				.validate5(" ^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#&()–[{}]:;',?/*~$^+=<>]).{8}$", password));
		...
		System.out.println(uppercasevalid
				.validate6("^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]){1}(?=.*[!@#&()–[{}]:;',?/*~$^+=<>]).{0,}$", uppercase));
		...
		System.out.println(numricnumber
				.validate7(" ^(?=.*[0-9]){1}(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#&()–[{}]:;',?/*~$^+=<>]).{0,}$", numric));
		System.out.println("*******************************");
		...
		System.out.println(specialchar
				.validate8(" ^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#&()–[{}]:;',?/*~$^+=<>]){1}.{0,}$", spcial));
	}
